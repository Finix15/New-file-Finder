...
- **Auto-rename functionality**: Automatically enters rename mode after file creation
- Customizable Quick Action name (English/Vietnamese support)
...
This project is a modified version based on [macos-new-file](https://github.com/dohsimpson/macos-new-file) by Doh.

**Enhancements by Finix:**
- ✨ Auto-rename functionality: File automatically enters rename mode after creation
- 🌏 Multi-language support: Customizable Quick Action name (English/Vietnamese)
- 🔧 Improved user experience with seamless file creation workflow
- 📖 Vietnamese documentation (README.vi.md)

Special thanks to [Doh](https://github.com/dohsimpson) for the original implementation!
